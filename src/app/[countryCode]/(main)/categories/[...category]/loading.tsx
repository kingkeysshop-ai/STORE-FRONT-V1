...
export default function Loading() {
  return (
    <div className="min-h-screen bg-gray-950">
      <div className="bg-gray-900 border-b border-yellow-400/20 py-12 animate-pulse">
        <div className="content-container flex flex-col items-center gap-3">
          <div className="w-24 h-5 bg-gray-800 rounded-full" />
          <div className="w-56 h-10 bg-gray-800 rounded-xl" />
          <div className="w-40 h-4 bg-gray-700 rounded-lg" />
        </div>
      </div>
      <div className="flex flex-col small:flex-row small:items-start py-8 content-container gap-6">
        <div className="small:min-w-[220px] bg-gray-900 border border-gray-700 rounded-xl p-4 animate-pulse">
          ...
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="w-full h-8 bg-gray-800 rounded-lg mb-2" />
          ))}
        </div>
